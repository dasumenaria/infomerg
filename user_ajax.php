 ...
 <div class="profile-sidebar">
						...
						<div class="portlet light profile-sidebar-portlet">
							...
							<div class="profile-userpic">
								<img src="upload/<?php echo $profile_pic;?>" class="img-responsive"   style="border-radius:50%!important;">
							</div>
							<!-- END SIDEBAR USERPIC -->
							<!-- SIDEBAR USER TITLE -->
							...
							<div class="col-md-8" >
								...
								<div class="portlet light " >
									...
									<div class="portlet-body">
										 ...
										 <?php 
												$posts_i=mysql_query("select * from `posts` where `id`='".$user_id."'  ORDER BY ID DESC limit 5 " );
										...
										?>
											<div class="row" style="border:2px solid #eee;">	
												<div class="col-md-2">
												<img src="upload/5.jpg" width="55px" height="55px" style="margin-top: 6px;margin-left: -9px;">
												 </div>
												<div class="col-md-10">
												<h4 style="margin-top: 17px;color: #428bca;font-weight:bold;">Lakshit Lohar</h4>
												</div>
												...
												<div class=" col-md-12">
												 ...
												 <h6>
												 <span style="margin-left: 20px;color: cornflowerblue;"><i class="fa fa-thumbs-up "></i>&nbsp; 199</span>
												 &nbsp; &nbsp; 
												 <span><i class="fa fa-calendar"></i>&nbsp;<?php echo $created_on;?></span>  
